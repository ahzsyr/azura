...
import { searchCopy } from "@/capabilities/search/components/search-ui/search-copy";
import { getRecentSearches } from "@/capabilities/search/components/search-history.storage";
