...
import type { SearchQueryInput, SearchQueryPlan } from "@/capabilities/search/engine/types";
...
import { sanitizeQuery, tokenize } from "@/capabilities/search/core/text";
import {
  parseTypesParam,
...
export class SearchQueryBuilder {
  ...
  /** @deprecated Use `@/capabilities/search/api/params` directly. */
