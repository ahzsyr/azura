...
export type SearchResult = {
  ...
  visibility: SearchVisibility;
  facets: Record<string, string | string[] | number | boolean>;
  card?: import("@/capabilities/search/types/search-card").SearchCardPayload;
  cardDisplay?: import("@/features/products/lib/product-search-display").ProductSearchCardDisplay;
};
