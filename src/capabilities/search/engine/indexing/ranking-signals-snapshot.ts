...
export function buildRankingSignalsFromComposed(
  ...
  if (source.collection) {
    const nameValues = Object.values(source.collection.name ?? {}).filter(Boolean);
    collectionParts.push(...nameValues, source.collection.slug);
  }
