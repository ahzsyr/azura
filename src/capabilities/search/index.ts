export { SEARCH_CAPABILITY_ID } from "./manifest";
export { searchCapability } from "./public/search-capability";
...
export { useSearchPageData } from "./hooks/use-search-page-data";
export * from "./query";
