import type { SearchQueryPlan, SearchRawRow } from "@/capabilities/search/engine/types";
import { buildRankingSignalsFromRow } from "@/capabilities/search/engine/indexing/ranking-signals-snapshot";
import {
  computeSmartLexicalBoost,
  computeTypoPenalty,
  smartScoreFromPlan,
} from "@/capabilities/search/engine/ranking/search-smart-scoring";
import type { ResolvedSearchRankingConfig } from "@/capabilities/search/engine/ranking/search-ranking-config";
import type { ResolvedSearchSmartConfig } from "@/capabilities/search/settings/resolve-search-smart-config";
import type { SearchRankingSignalId } from "@/capabilities/search/settings/search-ranking-signals";
import { multiKeywordScore, tokenize } from "@/capabilities/search/core/text";
