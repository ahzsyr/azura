...
/** Locale URL prefixes retired from public routing (redirect to default locale). */
export const RETIRED_URL_PREFIXES = new Set<string>();
...
export function getDirectionSync(
  ...
  return resolveDirection(urlPrefix, locales);
}
