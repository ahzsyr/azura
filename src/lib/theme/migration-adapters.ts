...
import type { BackgroundEffectSettings, MobileBrowserConfig, MotionSettings, VisualEffectSettings } from "@/types/theme";
...
export type ThemeConfig = {
  ...
  effects: {
    ...
    textEnabled: boolean;
    cursorSettings: VisualEffectSettings;
    textSettings: VisualEffectSettings;
  };
  cards: {
    style: string | null;
  };
  ...
  mobileBrowser: MobileBrowserConfig;
};
...
export function tokensToThemeConfig(tokens: ThemeTokens): ThemeConfig {
  return {
    ...
    motion: {
      ...
      settings: tokens.motionSettings,
    },
    effects: {
      ...
      cursorSettings: tokens.cursorEffectSettings,
      textSettings: tokens.textEffectSettings,
    },
    cards: {
    ...
    presets: {
      ...
      siteDefaultPresetId: tokens.siteDefaultPresetId ?? null,
    },
    accessibility: {},
    brand: {
    ...
    mobileBrowser: tokens.mobileBrowserConfig,
  };
}
...
export function themeConfigToTokens(config: ThemeConfig): ThemeTokens {
  return {
    ...
    cursorEffectSettings: config.effects.cursorSettings,
    textEffectSettings: config.effects.textSettings,
    motionSettings: config.motion.settings,
