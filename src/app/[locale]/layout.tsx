...
/** Dynamic locale shell — publish invalidation is the sole freshness mechanism. */
  ...
  try {
    ...
    return {
      ...
      icons: iconUrl
        ...
        : undefined,
      themeColor: [
        { media: "(prefers-color-scheme: light)", color: mobileBrowser.themeColorLight },
        { media: "(prefers-color-scheme: dark)", color: mobileBrowser.themeColorDark },
      ],
      appleWebApp: {
        capable: true,
        statusBarStyle: mobileBrowser.iosStatusBarStyle,
      },
  ...
  return (
    <div className="site-shell flex min-h-full flex-col">
      ...
      <NextIntlClientProvider locale={locale} messages={messages}>
        <SearchWarmCacheHost />
        <ThemeProvider resolved={resolvedTheme} previewDraft={previewDraft}>
          <DeferredNavigationProgress />
