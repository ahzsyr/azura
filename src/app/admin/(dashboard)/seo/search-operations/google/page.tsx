...
export default async function SearchOpsGoogleWorkspace() {
  ...
  const bpDiscovery = readBusinessProfileDiscovery(googlePlatform.platform);
  const bpRateLimited = isBusinessProfileRateLimited(bpDiscovery);
                ...
                <div className="flex flex-wrap gap-2">
                  ...
                  {card.primaryOperations[0] ? (
                    <CardActionButton
                      ...
                      disabled={card.id === "business_profile" && bpRateLimited}
                      hiddenFields={{
