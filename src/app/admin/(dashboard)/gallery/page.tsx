...
export default async function AdminGalleryPage({
  ...
  try {
    ...
    albums = withTranslations.map((row) => ({
      ...
      excerptEn: readAdminLocaleField(row, "excerpt", "en") || null,
      excerptAr: readAdminLocaleField(row, "excerpt", "ar") || null,
  ...
  return <GalleryManager albums={albums} locales={locales} initialCreateOpen={create === "1"} />;
}
