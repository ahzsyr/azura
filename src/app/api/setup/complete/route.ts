...
export async function POST(request: Request) {
  try {
    ...
    await Promise.all([
      publishShellChange({ entityType: "theme" }),
      publishShellChange({ entityType: "header" }),
      publishShellChange({ entityType: "footer" }),
      publishShellChange({ entityType: "site-settings" }),
    ]);
