...
import {
  ...
  type ThemeMode,
} from "@/lib/theme/apply-theme-transition";
...
export function ThemeModeToggle({ size = "md", showLabels = false, className, onThemeChange }: Props) {
  ...
  const toggle = useCallback(() => {
    ...
    // Paint class + next-themes inside one view transition when available.
  ...
  return (
    ...
    >
      ...
      <motion.span
        ...
        transition={{ type: "spring", stiffness: 680, damping: 38, mass: 0.6 }}
        className={cn(
