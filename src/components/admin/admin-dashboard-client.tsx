...
import { extractSubmissionContact } from "@/features/forms/lib/submission-contact";
...
const QUICK_ACTIONS = [
  { label: "CMS Pages", href: "/admin/pages", icon: FileText, description: "CMS pages" },
  { label: "Form Submissions", href: "/admin/form-submissions", icon: Inbox, description: "Submission inbox" },
...
export function AdminDashboardClient({
  ...
  const catalogCards = [
    { label: "Packages", value: stats.packages, icon: Package, href: "/admin/content/catalog-items" },
    { label: "Form Submissions", value: stats.newFormSubmissions, icon: Inbox, href: "/admin/form-submissions", accent: true },
          ...
          <Card>
            <CardHeader className="flex flex-row items-center justify-between space-y-0">
              ...
              <Button asChild variant="outline" size="sm">
                <Link href="/admin/form-submissions">View all</Link>
              </Button>
            </CardHeader>
            <CardContent>
              {recentSubmissions.length === 0 ? (
                ...
                <ul className="divide-y divide-[var(--admin-border)] rounded-lg border border-[var(--admin-border)]">
                  {recentSubmissions.map((submission) => {
                    ...
                    const displayName = contact.name ?? submission.template?.name ?? "Submission";
                    return (
