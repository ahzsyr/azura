...
type AdminFormProviderProps = {
  ...
  /** Semantic owner key for the action stack. Defaults to trackFormId or "admin-form". */
  ownerKey?: string;
  scope?: string;
  priority?: number;
  entityId?: string;
...
export function AdminFormProvider({
  ...
  const resolvedOwnerKey = ownerKey ?? trackFormId ?? "admin-form";
