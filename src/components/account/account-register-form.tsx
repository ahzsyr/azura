...
export function AccountRegisterForm({ locale }: Props) {
  ...
  async function verifyCode(e: React.FormEvent) {
    ...
    router.replace(`${accountPublicPath(locale, "login")}?verified=1`);
  }
    ...
    return (
      <Card className="mx-auto w-full max-w-md">
        ...
        <CardFooter className="justify-center">
          <Link href={accountPublicPath(locale, "login")} className="text-primary text-sm underline">
            {t("signIn")}
          </Link>
        </CardFooter>
      </Card>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <CardFooter className="flex flex-col gap-4">
          ...
          <p className="text-muted-foreground text-center text-sm">
            ...
            <Link href={accountPublicPath(locale, "login")} className="text-primary font-medium underline">
              {t("signIn")}
            </Link>
          </p>
        </CardFooter>
