...
function FiltersSkeleton() {
  return (
    <aside className="pl-sidebar pl-sidebar--pinned" aria-hidden="true">
      <section className="pl-sidebar-chrome space-y-3 p-3">
...
function ListingSkeletonLayout({ children }: { children: ReactNode }) {
  return (
    <CatalogContentLayout sidebar={<FiltersSkeleton />}>
      {children}
...
function CatalogGridSkeleton() {
  return (
    <ListingSkeletonLayout>
      <SkeletonBlock className="mb-4 h-10 w-full rounded-xl" />
      <GridSkeleton />
      <SkeletonBlock className="mx-auto mt-6 h-9 w-64 max-w-full rounded-full" />
    </ListingSkeletonLayout>
  );
}
...
function SearchSkeleton() {
  return (
    <ListingSkeletonLayout>
      <SkeletonBlock className="mb-6 h-10 w-full rounded-lg" />
