...
export const analyticsAggregateService = {
  async rollupDay(day: Date = new Date()) {
    ...
    await prisma.marketingMetricRollup.upsert({
      where: {
        periodStart_periodEnd_granularity_internalCampaignId_sourceId_providerId_providerBindingId_landingPagePath_conversionType_trafficType: {
          periodStart: start,
          periodEnd: end,
          granularity: "day",
          ...
          providerBindingId: null as unknown as string,
