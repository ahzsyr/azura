  ...
  return (
    <div className="space-y-6">
      <AdminPageHeader
        ...
        description="Generate tracking URLs linked to internal campaigns. utm_campaign is a label; the internal campaign FK is authoritative."
      />
      <Card>
        <CardHeader>
        ...
        <CardContent>
          <form action={createTrackingUrlAction} className="grid gap-3 md:grid-cols-2">
