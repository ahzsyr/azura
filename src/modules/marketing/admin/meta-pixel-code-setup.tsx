...
export function MetaPixelCodeSetup({ config }: { config?: MetaTrackingConfig | null }) {
    ...
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          ...
          enabled, this site installs it in the document head automatically (same placement as
          Meta&apos;s &quot;Paste base code between &lt;head&gt; tags&quot; step).
        </CardDescription>
      </CardHeader>
      <CardContent>
        <form action={upsertTrackingConfigAction} className="space-y-5">
          ...
          <div className="rounded-lg border border-border/70 bg-muted/20 p-4">
            ...
            <ol className="mt-2 list-decimal space-y-1 pl-5 text-sm text-muted-foreground">
              ...
              <li>Enable Pixel and save — we inject the code on the public site for you.</li>
            </ol>
          </div>
          ...
          {enabled && resolvedPixelId ? (
            <p className="text-xs text-emerald-700 dark:text-emerald-300">
              Base code will be installed on the public site after save
            </p>
          ) : null}
