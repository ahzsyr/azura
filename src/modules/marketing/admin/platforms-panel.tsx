  ...
  return (
    <div className="space-y-5">
      <AdminPageHeader
        ...
        description="Save provider app credentials, then connect Meta, Google Ads, and LinkedIn ad accounts. Secrets are encrypted at rest. Social publishing is optional and separate."
      />
