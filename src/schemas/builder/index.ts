...
export const BLOCK_DEFAULTS: Record<string, Record<string, unknown>> = {
  ...
  faqSetGrid: { title: "", subtitle: "", columns: 3 },
  testimonials: {
    title: "Testimonials",
    source: "collection",
  ...
  contactMap: {
    ...
    description: "",
    icon: "mapPin",
    provider: { type: "google", embedUrl: "", zoom: 14 },
    height: 400,
    roundedCorners: true,
    showMarker: true,
    markerLabel: "",
  ...
  contactLocation: {
    ...
    osmUrl: "",
    showMapsButton: true,
    mapsButtonText: "Find us on Google Maps",
    mapsButtonsLayout: "row",
    mapsButtonsStyle: "outline",
    autoMapsButtons: true,
    mapsButtons: [],
  },
  contactPhone: {
    title: "Phone & email",
