...
export const sectionSpacingPresetSchema = z.enum([
  "none",
  "compact",
  "default",
  "large",
...
export const blockLayoutStylesSchema = z
  .object({
    ...
    sectionSpacingPreset: sectionSpacingPresetSchema.optional(),
    paddingTop: cssLengthSchema.optional(),
    paddingBottom: cssLengthSchema.optional(),
    paddingTopPreset: sectionSpacingPresetSchema.optional(),
    paddingBottomPreset: sectionSpacingPresetSchema.optional(),
