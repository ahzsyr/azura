...
/** Fallback when NEXT_PUBLIC_APP_VERSION is unset (keep in sync with package.json). */
export const SITE_PRODUCT_VERSION_FALLBACK = "0.1.0";

export function getProductVersion(): string {
  return env("NEXT_PUBLIC_APP_VERSION", SITE_PRODUCT_VERSION_FALLBACK);
}
