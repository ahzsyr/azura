...
export const ADMIN_NAV_GROUPS: AdminNavGroup[] = [
  ...
  },
  {
    ...
    label: "SEO",
    items: [
      { href: "/admin/seo", label: "SEO", icon: Search, keywords: ["meta", "search"], navItemId: "seo-overview" },
      { href: "/admin/seo/audit", label: "SEO Audit", icon: Search, keywords: ["analysis"], navItemId: "seo-audit" },
      { href: "/admin/seo/redirects", label: "Redirects", icon: Route, keywords: ["urls"], navItemId: "seo-redirects" },
      { href: "/admin/seo/robots", label: "Robots.txt", icon: Bot, keywords: ["crawl"], navItemId: "seo-robots" },
      { href: "/admin/seo/structured-data", label: "Structured Data", icon: Braces, keywords: ["schema", "json-ld"], navItemId: "seo-structured-data" },
      { href: "/admin/seo/integrations", label: "SEO Integrations", icon: Activity, keywords: ["gsc", "bing", "indexnow"], navItemId: "seo-integrations" },
      { href: "/admin/seo/404", label: "404 Pages", icon: AlertCircle, keywords: ["not found"], navItemId: "seo-404" },
    ],
  },
  {
    id: "settings",
