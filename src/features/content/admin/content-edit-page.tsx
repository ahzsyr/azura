...
export function ContentEditPage({
  ...
  const itemExcerpt = itemField("excerpt", "en");
  const itemDescription = itemField("description", "en");
            ...
            source:
              contentType.slug === "catalog-items"
                ...
                : contentType.slug === "listings"
                  ...
                  : "services",
            nameEn: itemTitle,
            nameAr: itemField("title", "ar"),
            excerptEn: itemExcerpt,
            excerptAr: itemField("excerpt", "ar"),
