...
export function ContentEditPage({
  ...
  const shell = (
    <>
      <AdminPageConfigRegistrar configKey="contentItemEditor" />
    <EntityAdminShell
      ...
      ownerKey="content-item-editor"
      scope="content-item-editor"
      priority={0}
      entityId={item?.id}
      onSave={() => void submitContentForm()}
      ...
      canPreview={Boolean(previewHref) && item?.status === "PUBLISHED"}
      headerActions={
        item ? (
