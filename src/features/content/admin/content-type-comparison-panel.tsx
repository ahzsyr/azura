                      ...
                      renderFieldEditor={(field, index) => (
                        <div className="rounded-lg border p-3 text-sm space-y-2">
                          ...
                          <div className="grid gap-2 sm:grid-cols-2">
                            <div>
                              <Label className="text-xs">Compare label (EN)</Label>
                              <Input
                                className="h-8"
                                value={field.compareLabelEn ?? ""}
                                placeholder={field.labelEn}
                                onChange={(e) =>
                                  updateField(index, {
                                    compareLabelEn: e.target.value || undefined,
                                  })
                                }
                              />
                            </div>
                            <div>
                              <Label className="text-xs">Compare label (AR)</Label>
                              <Input
                                className="h-8"
                                value={field.compareLabelAr ?? ""}
                                placeholder={field.labelAr ?? field.labelEn}
                                onChange={(e) =>
                                  updateField(index, {
                                    compareLabelAr: e.target.value || undefined,
                                  })
                                }
                              />
                            </div>
                ...
                {compareFields.length > 0 ? (
                  <div className="space-y-3">
                    ...
                    {compareFields.map((field) => {
                      ...
                      return (
                        <div key={field.key} className="grid gap-2 sm:grid-cols-2 text-sm border-t pt-2">
                          <span className="sm:col-span-2 font-medium text-muted-foreground">
                            {field.key}
                          </span>
                          <div>
                            <Label className="text-xs">Override label (EN)</Label>
                            <Input
                              className="h-8"
                              value={ov?.labelEn ?? ""}
                              onChange={(e) =>
                                updateSettingsAttributes(
                                  setOverride(settings.attributes, {
                                    key: field.key,
                                    labelEn: e.target.value || undefined,
                                  })
                                )
                              }
                            />
                          ...
                          <div>
                            <Label className="text-xs">Override label (AR)</Label>
                            <Input
                              className="h-8"
                              value={ov?.labelAr ?? ""}
                              onChange={(e) =>
                                updateSettingsAttributes(
                                  setOverride(settings.attributes, {
                                    key: field.key,
                                    labelAr: e.target.value || undefined,
                                  })
                                )
                              }
                            />
