...
import type { ContentItemMedia } from "@prisma/client";
import {
            ...
            <div className="min-w-0 flex-1 space-y-2">
              ...
              >
                <div className="space-y-1">
                  ...
                  <Input name="altEn" defaultValue={item.altEn} className="h-8 text-sm" />
                </div>
                <div className="space-y-1">
                  <Label className="text-xs">Alt (AR)</Label>
                  <Input name="altAr" defaultValue={item.altAr} className="h-8 text-sm" dir="rtl" />
                </div>
