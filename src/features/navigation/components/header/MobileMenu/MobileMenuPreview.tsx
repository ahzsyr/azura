...
export function MobileMenuPreview({
  ...
  useEffect(() => {
    ...
    // #region agent log
    fetch('http://127.0.0.1:7876/ingest/6e6c5bde-6579-4633-b8e0-f055b7efa2da',{method:'POST',headers:{'Content-Type':'application/json','X-Debug-Session-Id':'7ac260'},body:JSON.stringify({sessionId:'7ac260',runId:'ui-runtime-debug',hypothesisId:'H6',location:'src/features/navigation/components/header/MobileMenu/MobileMenuPreview.tsx:499',message:'MobileMenuPreview mounted with pathname hook',data:{pathname:pathname ?? null,surface,mobileType,itemCount:mobileItems.length},timestamp:Date.now()})}).catch(()=>{});
    // #endregion
  }, [mobileItems.length, mobileType, pathname, surface]);
