...
export function BrandingPanel({ branding, brandingSourceReady = true, onChange, description }: Props) {
  ...
  return (
    <div className="space-y-4">
        ...
        {form.logoMode === "image" ? (
          <div className="mt-4 grid gap-4 lg:grid-cols-2">
            <UrlPrimaryMediaPickerField
              ...
              hint="PNG, WebP, or SVG. SVG is recommended for crisp logos."
            ...
            <UrlPrimaryMediaPickerField
              ...
              hint="PNG, WebP, or SVG. Use a light-colored variant for dark headers."
      ...
      <AdminCollapsibleSection
        title="Translations"
        description="Edit branding text in the active admin locale. Default locale values also sync to header JSON."
        defaultOpen={false}
      >
        <div className="space-y-4">
          <WorkspaceLocalizedField
            ...
            label="Brand name"
            legacyEntity={{ siteDescription: form.brandName }}
            onDefaultLocaleChange={(value) => updateForm({ brandName: value }, true)}
          />
          <WorkspaceLocalizedField
            entityType="SiteIdentity"
            entityId="default"
            field="siteTagline"
            label="Brand tagline"
            legacyEntity={{ siteTagline: form.tagline }}
            onDefaultLocaleChange={(value) => updateForm({ tagline: value }, true)}
          />
        </div>
      </AdminCollapsibleSection>
    </div>
