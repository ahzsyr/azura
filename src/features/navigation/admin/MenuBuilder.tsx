...
function typeIconElement(type: MenuItemType) {
  ...
  switch (type) {
    ...
    case "tag":
      return <TagIcon className={iconClassName} />;
    case "product":
    case "package":
                  ...
                  {inspectorItem ? (
                    <>
                      ...
                      <div className="space-y-3 rounded-lg border bg-muted/15 p-3">
                        ...
                        inspectorItem.type === "post" ||
                        inspectorItem.type === "package" ||
                        (inspectorItem.type === "link" &&
                          /^\/(services|hotels-transport|packages)\//.test(
                            inspectorItem.url ?? "",
                          )) ? (
                          <PageSourceCascade
                            catalog={catalog}
                            idPrefix="inspector-src"
                            editingItem={inspectorItem}
                            onChange={(next) => {
                              if (!next) return;
                              const fields = applySourceTargetToFields(next);
                              updateMenuItem(inspectorItem.id, {
                                type: fields.type,
                                label: fields.label || inspectorItem.label,
                                url: fields.url,
                        ...
                        {inspectorItem.type === "collection" ||
                        inspectorItem.type === "packageCategory" ? (
                          <CollectionSourceCascade
                            catalog={catalog}
                            idPrefix="inspector-col"
                        ...
                        {inspectorItem.type === "brand" ? (
                          <div className="space-y-1">
                            <Label>Brand</Label>
                            <BrandSelect
                              catalog={catalog}
                              id="inspector-brand"
                              value={inspectorItem.brandSlug ?? ""}
                              onChange={(brandSlug) => {
                                updateMenuItem(inspectorItem.id, {
                                  brandSlug,
                        ...
                        {inspectorItem.type === "tag" ? (
                          <div className="space-y-1">
                            <Label>Tag</Label>
                            <TagSelect
                              catalog={catalog}
                              id="inspector-tag"
                              value={inspectorItem.tagSlug ?? ""}
                              onChange={(tagSlug) => {
                                updateMenuItem(inspectorItem.id, {
                                  tagSlug,
                        ...
                        !/^\/(services|hotels-transport|packages)\//.test(
                          ...
                          <div className="space-y-1">
                            ...
                            <Input
                              ...
                              onChange={(e) =>
                                updateMenuItem(inspectorItem.id, { url: e.target.value })
                              }
                              onBlur={queueSave}
                            />
                          </div>
                        ...
                        {inspectorItem.type === "image" ? (
                          <div className="space-y-1">
                            ...
                            <Input
                              ...
                              onChange={(e) =>
                                updateMenuItem(inspectorItem.id, { linkUrl: e.target.value })
                              }
                              onBlur={queueSave}
                            />
                          </div>
                      ...
                      <div className="space-y-3 rounded-lg border p-3">
                        ...
                        <MenuItemLocalizedFields
                          ...
                          itemId={inspectorItem.id}
                          defaultLabel={inspectorItem.label}
                          defaultBadgeText={inspectorItem.badgeText ?? ""}
                          defaultCardSubtitle={
                            (inspectorItem as { cardSubtitle?: string }).cardSubtitle ?? ""
                          }
                          onDefaultLabelChange={(value) =>
                            updateMenuItem(inspectorItem.id, { label: value })
                          }
                          onDefaultBadgeTextChange={(value) =>
                            updateMenuItem(inspectorItem.id, { badgeText: value })
                          }
