...
import { HeaderWorkspaceActions, useHeaderWorkspacePublish, useHeaderWorkspaceSave } from "./HeaderWorkspaceActions";
...
function HeaderDashboardContent({
  catalog,
  refreshCatalog,
}: {
  ...
  return (
    <HeaderBuilderCatalogProvider catalog={catalog} refreshCatalog={refreshCatalog}>
      <HeaderDirtySync />
      <DesignHubShell
        title="Header"
  ...
  return (
    ...
    >
      <AdminFormProvider onSave={onSave} onCancel={onCancel} onPublish={onPublish}>
        ...
        <HeaderDashboardContent catalog={catalog} refreshCatalog={refreshCatalog} />
      </AdminFormProvider>
    </WorkspaceTranslationProvider>
  );
}
