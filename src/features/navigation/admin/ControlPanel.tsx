            ...
            <div>
              ...
              <div className="mt-2">
                <OptionButtonGroup
                  ...
                  options={[
                    { value: "boxed-on", label: "Boxed on" },
                    { value: "boxed-off", label: "Boxed off" },
                  ]}
                  onChange={(v) => setSettings({ mobileBoxedSticky: v === "boxed-on" })}
                  columns={2}
                />
              </div>
              {settings.mobileBoxedSticky !== true ? (
                <div className="mt-2">
                  <OptionButtonGroup
                    value={settings.mobileFlushTop !== false ? "auto-remove-on" : "auto-remove-off"}
                    options={[
                      { value: "auto-remove-on", label: "Auto remove on" },
                      { value: "auto-remove-off", label: "Auto remove off" },
                    ]}
                    onChange={(v) => setSettings({ mobileFlushTop: v === "auto-remove-on" })}
                    columns={2}
                  />
                  <p className="mt-1 text-xs text-muted-foreground">
                    Auto remove top gap flushes the header to the screen edge when boxed mobile
                    header is off.
                  </p>
                </div>
              ) : null}
    ...
    return (
      <div className="space-y-4">
        ...
        <AdminCollapsibleSection
          ...
          description="Display the site header over media underlays (hero, banner, cover). Product and listing pages without a banner keep a normal header."
          defaultOpen
        >
          <div className="space-y-4">
            <label className="flex items-center gap-2 text-sm">
