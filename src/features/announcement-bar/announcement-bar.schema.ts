import { z } from "zod";
import { newId } from "@/features/marketing-blocks/schemas/marketing-blocks";
...
export const DEFAULT_ANNOUNCEMENT_BAR_ITEMS: AnnouncementItem[] = [
  { id: newId("ab"), messageEn: "99.97% Network Uptime SLA", messageAr: "اتفاقية مستوى خدمة 99.97٪", message: "", title: "", titleEn: "", titleAr: "", description: "", descriptionEn: "", descriptionAr: "", linkUrl: "", icon: "", badge: "", badgeEn: "", badgeAr: "" },
  { id: newId("ab"), messageEn: "Fiber & Wireless Last-Mile Delivery", messageAr: "توصيل الألياف واللاسلكي للميل الأخير", message: "", title: "", titleEn: "", titleAr: "", description: "", descriptionEn: "", descriptionAr: "", linkUrl: "", icon: "", badge: "", badgeEn: "", badgeAr: "" },
  { id: newId("ab"), messageEn: "24 / 7 NOC Monitoring", messageAr: "مراقبة مركز العمليات على مدار الساعة", message: "", title: "", titleEn: "", titleAr: "", description: "", descriptionEn: "", descriptionAr: "", linkUrl: "", icon: "", badge: "", badgeEn: "", badgeAr: "" },
  { id: newId("ab"), messageEn: "Enterprise & SME Solutions", messageAr: "حلول المؤسسات والشركات الصغيرة والمتوسطة", message: "", title: "", titleEn: "", titleAr: "", description: "", descriptionEn: "", descriptionAr: "", linkUrl: "", icon: "", badge: "", badgeEn: "", badgeAr: "" },
  { id: newId("ab"), messageEn: "Nationwide Coverage", messageAr: "تغطية على مستوى الدولة", message: "", title: "", titleEn: "", titleAr: "", description: "", descriptionEn: "", descriptionAr: "", linkUrl: "", icon: "", badge: "", badgeEn: "", badgeAr: "" },
];
