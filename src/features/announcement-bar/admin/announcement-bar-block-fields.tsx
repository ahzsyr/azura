      ...
      >
        <ModalRepeatableListEditor
          ...
          strings={{
            ...
            emptyLabel: "No items yet. Click Add announcement to create one.",
            dialogTitleCreate: "Add announcement",
            dialogTitleEdit: "Edit announcement",
            saveButtonLabelCreate: "Save announcement",
            saveButtonLabelEdit: "Save announcement",
          }}
          renderSummary={(item) => {
            const msg =
            ...
            return { title: msg, meta: link ? [`Link: ${link}`] : [] };
          }}
          renderForm={(draft, onUpdate) => (
            <div className="space-y-3">
              <LocalizedItemFields
                ...
                onChange={(patch) => onUpdate(patch as Partial<AnnouncementItem>)}
              />
              <div>
