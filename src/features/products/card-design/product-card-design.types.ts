...
export type ProductCardContentAlignment = "left" | "center" | "mixed";

export type ProductCardSurface = "flat" | "elevated" | "glass" | "premium";

export type ProductCardQuickViewMode = "disabled" | "hover_overlay" | "action_button";

export type ProductCardViewDetailsMode = "disabled" | "product_page" | "quick_view";
...
export interface ProductCardDesignPartial {
  ...
  cardSurface?: ProductCardSurface;
  quickViewMode?: ProductCardQuickViewMode;
  viewDetailsMode?: ProductCardViewDetailsMode;
