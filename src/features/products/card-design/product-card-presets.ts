...
export const PRODUCT_CARD_PRESETS: ProductCardPresetDefinition[] = [
  ...
  },
  {
    id: "media_flip",
    label: "Media Flip",
    description: "Product-focused front, summary back, stable CTA bar",
    patch: {
      style: "media_flip",
      layout: "classic_grid",
      motion: "premium",
      ...
      pricingMode: "luxury",
      showCategory: true,
      quickViewMode: "disabled",
      viewDetailsMode: "product_page",
      contentOrder: ["brand", "title", "category", "description", "features", "actions"],
      effects: {
        enabled: false,
      ...
      actions: {
        enabledTypes: ["buy_now", "cta", "wishlist", "compare"],
        customActions: [],
        primaryAction: "cta",
      },
    },
