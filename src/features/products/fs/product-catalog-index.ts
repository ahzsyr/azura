...
function buildRuleMeta(
  ...
  const matchingRules = [
    ...normalizeMatchingRulesFromRaw(raw.matchingRules),
    ...normalizeMatchingRulesFromRaw(raw.matching_rules),
  ];
...
function normalizeMatchingRulesFromRaw(raw: unknown): string[] {
  if (raw == null) return [];
