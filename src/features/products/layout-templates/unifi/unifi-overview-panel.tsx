...
import type { ProductDetailedSection, ProductFeatureCard, ProductFeatureHotspot } from "@/features/products/types";
...
function hotspotTipStyle(hotspot: ProductFeatureHotspot): CSSProperties {
  return {
    "--tip-x": clampUnit(hotspot.tooltipX ?? hotspot.dotX, 0.08),
    "--tip-y": clampUnit(hotspot.tooltipY ?? hotspot.dotY, 0.08),
  } as CSSProperties;
}
                ...
                {url ? (
                  <div className="unifi-overview__feature-media">
                    ...
                    {hasHotspot && (feature.title || feature.body) ? (
                      <figcaption className="unifi-overview__hotspot-tip" style={hotspotTipStyle(hotspot)}>
