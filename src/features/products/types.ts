import type {
  CanonicalSpecRecord,
  SpecMatchConfidence,
  UnmappedSpecDiagnostic,
} from "@/features/specifications/types";

export type { CanonicalSpecRecord, SpecMatchConfidence };
export type SpecDiagnostic = UnmappedSpecDiagnostic;
...
export type ProductStockStatus = "in_stock" | "out_of_stock" | "preorder" | "backorder";
...
export interface Product {
  ...
  unmapped_specs?: SpecDiagnostic[];
  ambiguous_specs?: SpecDiagnostic[];
  ...
  /** Google product taxonomy override (ID or path). */
  googleProductCategory?: string;
  /** Optional Shopping title override (max 150 chars). */
  googleTitle?: string;
  /** Optional Shopping description override. */
  googleDescription?: string;
  /** Optional custom_label_0 for Merchant Center segmentation. */
  customLabel0?: string;
