...
export function ProductListingIsland({
  ...
  const filtersToggleBtn = !pinnedSidebar ? (
    <button
      type="button"
  ...
  const dockPeekActions =
    dockEnabled && (filtersToggleBtn || viewSwitcher) ? (
      <div className="pl-catalog-dock-peek">
        {filtersToggleBtn}
        {viewSwitcher}
      </div>
    ) : null;
  ...
  const catalogToolbar = (
    ...
    >
      ...
      <div className="pl-catalog-toolbar__row pl-catalog-toolbar__row--search">
        ...
        >
          {!pinnedSidebar ? filtersToggleBtn : null}
