...
export function CollectionCatalogCard({
  ...
  return (
    <article className="cl-catalog-card" {...sharedElementRootAttrs("collection", collection.slug)}>
      <LocaleLink href={navHref} className="cl-catalog-card__link" aria-label={`${collection.name} — ${viewLabel}`}>
        <div
          className={
            bannerSrc
        ...
        <div className="cl-catalog-card__body">
          ...
          <h3
            className="cl-catalog-card__title"
