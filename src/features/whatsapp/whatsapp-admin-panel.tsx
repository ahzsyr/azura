          ...
          tab === "overview" ? (
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Read-only preview of WhatsApp copy from{" "}
                  <code className="text-xs">messages/{"{locale}"}.json</code> under the{" "}
                  <code className="text-xs">whatsapp</code> namespace. Edit those files and redeploy
                  to change templates.
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-6">
                    ...
                    return (
                      ...
                      >
                        <Textarea
                          ...
                          readOnly
                          rows={3}
                          className="min-h-[88px] resize-y bg-muted/40"
                        />
                        <p className="text-xs text-muted-foreground">
                          File key: <code>whatsapp.{item.key}</code>
                        </p>
                      </AdminCollapsibleSection>
                    );
                  })}
