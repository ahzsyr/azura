...
import type { SearchProvider } from "@/features/search-framework/providers/search-provider";
import { BUILTIN_SEARCH_PROVIDERS } from "@/features/search-framework/providers/builtin-providers";
import { CATALOG_SEARCH_PROVIDERS } from "@/features/search-framework/providers/catalog-providers";
import {
  entityTypeToKind,
  kindFromMetadata,
  kindToEntityType,
} from "@/features/search-framework/schema/kind-map";
...
export class SearchRegistry {
  ...
  constructor() {
    for (const provider of [...BUILTIN_SEARCH_PROVIDERS, ...CATALOG_SEARCH_PROVIDERS]) {
