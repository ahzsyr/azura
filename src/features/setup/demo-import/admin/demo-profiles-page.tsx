...
export function DemoProfilesPage({ profiles, lastApplied }: Props) {
  ...
  function handleDelete() {
    ...
    setActionError(null);
    startTransition(async () => {
      const result = await deleteDemoProfileAction(deleteTarget.id as ProfileId);
      if (!result.success) {
        setActionError(result.error);
        return;
      }
            ...
            <CardContent className="mt-auto space-y-4">
              ...
              <div className="flex flex-wrap gap-2">
                ...
                <Button
                  ...
                  disabled={pending || !profile.deletable}
                  title={!profile.deletable ? "At least one profile must remain" : undefined}
                >
