        ...
        <div className="space-y-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Reference links shown at the bottom of this post.</CardDescription>
            </CardHeader>
            <CardContent>
              <CitationSourcesField value={sources} onChange={(s) => { setSources(s); markDirty(); }} />
            </CardContent>
          </Card>
...
export function PostEditorForm({
  ...
  const shouldSuppressPageActions = isSeoTab && Boolean(post?.id);
  ...
  return (
    <AdminFormProvider
      ...
      onPublish={!shouldSuppressPageActions ? handlePublish : undefined}
      onPreview={shouldSuppressPageActions ? undefined : handlePreview}
      canPublish={!shouldSuppressPageActions}
      canCancel
