          ...
          <>
            ...
            {tab === "seo" && page?.id && (
              <SeoMetaPanel
                ...
                cmsPageId={page.id}
                meta={page.seoMeta}
                defaultTitleEn={formState.localeFields.title?.en ?? ""}
                defaultTitleAr={formState.localeFields.title?.ar ?? ""}
                defaultDescEn={formState.localeFields.excerpt?.en ?? ""}
                defaultDescAr={formState.localeFields.excerpt?.ar ?? ""}
              />
            )}
...
export function PageEditorForm({
  ...
  const baselineFormStateRef = useRef<PageFormState>(
    structuredClone({ ...formState, blocks: blocksRef.current }),
  );
