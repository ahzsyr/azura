...
export function buildPageEditorFormData(
  ...
  if (locales.length > 0) {
    ...
    formData.set("titleEn", state.localeFields.title?.en ?? state.titleEn);
    formData.set("titleAr", state.localeFields.title?.ar ?? state.titleAr);
    formData.set("excerptEn", state.localeFields.excerpt?.en ?? state.excerptEn);
    formData.set("excerptAr", state.localeFields.excerpt?.ar ?? state.excerptAr);
  }
