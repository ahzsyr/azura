...
/** True when the editor sent block translation overrides (including empty clears). */
export function hasBlockTranslationEdits(
  blockTranslationsRaw: string | null | undefined,
): boolean {
  return (
    typeof blockTranslationsRaw === "string" &&
    blockTranslationsRaw.length > 0 &&
