/**
 * @deprecated Use DataPlatformConsole from @/features/data-platform/components/data-platform-console
 * instead. This component is kept only until the old database/page.tsx is fully migrated.
 */
"use client";
