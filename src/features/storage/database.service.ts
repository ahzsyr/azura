/**
 * @deprecated Use platformService from @/features/data-platform/services/platform.service
 * instead. This module is kept for backward compatibility and will be removed in a future
 * cleanup pass once all callers have been migrated.
 */
