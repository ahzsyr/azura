...
import { resolveLocalizedSeoExtras } from "@/features/seo/localized-seo-fields";
...
export { parseJsonLdTranslation } from "@/features/seo/localized-seo-fields";
...
export async function resolveEffectiveSeoForLocale(
  ...
  const localizedExtras = resolveLocalizedSeoExtras(languageCode, ctx, meta);
