...
export const STATIC_SEO_PAGES = [
  ...
  { pageKey: "smart-home", label: "Smart home", path: "/smart-home" },
  { pageKey: "security-solutions", label: "Security solutions", path: "/security-solutions" },
  { pageKey: "enterprise-wireless", label: "Enterprise wireless", path: "/enterprise-wireless" },
] as const;
