...
export const STATIC_SEO_PAGES = [
  ...
  { pageKey: "videos", label: "Videos", path: "/videos" },
...
export const SEO_APPEARANCE_NAMESPACE = "seo-appearance";
export const SEO_URL_INSPECTION_NAMESPACE = "seo-url-inspection";
