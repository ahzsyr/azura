...
/** @deprecated Only used by legacy `buildMetadata()`; production head path uses `documentToMetadata`. */
...
export function applyMetadataContributors(
  ...
  let metadata: Metadata = {
    // Absolute prevents parent layout `title.template` from appending the brand again.
    title: { absolute: ctx.displayTitle },
    description: ctx.description,
  };
