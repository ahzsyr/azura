  ...
  return {
    ...
    page: {
      ...
      breadcrumbItems: [
        ...
        { name: "Industrial Router", href: "/products/industrial-router" },
      ],
      product: {
        id: "prod-1",
    ...
    runtime: {
      ...home.runtime,
      canonicalUrl: `${baseSiteOrigin}/products/industrial-router`,
    },
  };
}
...
export function createFaqContextFixture(): SchemaContext {
  ...
  return {
    ...
    page: {
      ...
      breadcrumbItems: [
        { name: "Home", href: "/" },
        { name: "Support FAQ", href: "/faq/support" },
      ],
    },
    runtime: {
      ...home.runtime,
      canonicalUrl: `${baseSiteOrigin}/faq/support`,
    },
    site: {
      ...home.site,
      structuredConfig: {
        ...home.site.structuredConfig,
        builderFlags: { faqBuilder: true },
      },
    },
  };
}
...
export function createCmsFaqBlocksContextFixture(): SchemaContext {
  ...
  return {
    ...
    runtime: {
      ...home.runtime,
      canonicalUrl: `${baseSiteOrigin}/smart-home`,
    },
  };
}
