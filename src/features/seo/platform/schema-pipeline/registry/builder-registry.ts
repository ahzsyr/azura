...
function withGoogleMeta(builder: SchemaBuilder): SchemaBuilder {
  const google = googleMetaForBuilder(builder.id);
  return google ? { ...builder, google } : builder;
}
