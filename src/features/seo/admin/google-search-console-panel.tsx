...
export function GoogleSearchConsolePanel({
  ...
  }, [savePending, saveState, router, searchParams, markSaved, setSaveStatus]);
  ...
  useAdminPageActions({
    ownerKey: "seo-google-search-console",
    scope: "settings",
    priority: 0,
    onSave: handleSave,
  ...
  return (
    <div className={embedded ? "space-y-6" : "max-w-3xl space-y-6"}>
      ...
      <form key={formKey} ref={formRef} id="google-search-console-form" action={saveAction} className="space-y-6">
        <Card>
          <CardHeader>
