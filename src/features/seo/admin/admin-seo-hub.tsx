...
const TOOL_LINKS = [
  ...
  },
  {
    ...
    icon: Search,
    title: "SEO Workspace",
    description: "Health score, technical audit, and issues",
  },
  {
    href: "/admin/seo/content",
    icon: FileText,
    title: "Content Audit",
    description: "Structure, metadata preview, and entity issues",
  },
  {
  ...
  },
  {
    ...
    icon: Map,
    title: "Sitemap",
    description: "Exclude paths or add custom URLs",
  },
  {
  ...
  },
  {
    ...
    description: "Command center, entities, pages, Google ops, and automation",
  },
  {
