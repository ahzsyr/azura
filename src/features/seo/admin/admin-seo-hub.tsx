...
const TOOL_LINKS = [
  ...
  },
  {
    ...
    icon: Activity,
    title: "Integrations",
    description: "Search platform submissions and queue health",
  },
  {
    href: "/admin/seo/404",
    icon: AlertCircle,
    ...
    <div className="space-y-6 max-w-6xl">
      ...
      >
        {(tab) => {
          ...
          if (tab === "health") {
            return (
              <div className="space-y-6">
                ...
                <Link href="/admin/seo/integrations" className="text-sm text-primary hover:underline">
          ...
          return <StaticPagesSeoPanel metaByKey={metaByKey} translationsByKey={translationsByKey} />;
        }}
      </AdminSettingsLayout>
    </div>
  );
