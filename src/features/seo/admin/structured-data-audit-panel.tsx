...
export function StructuredDataAuditPanel({
  ...
  const [selectedRoute, setSelectedRoute] = useState(PUBLIC_SCHEMA_AUDIT_ROUTES[0]?.pathname ?? "/");
  ...
  function runAudit(pathname: string) {
    ...
    startTransition(async () => {
      const result = await runAdminAction(
        ...
        () => runStructuredDataAuditAction(pathname),
        "Structured data audit finished.",
      );
      setAudit(result);
    });
  }
          ...
          <div className="grid gap-6 xl:grid-cols-2">
            ...
            <div className="space-y-4">
              <GoogleRichResultPreview
                ...
                showBrandSimulation={selectedRoute === "/"}
              />
