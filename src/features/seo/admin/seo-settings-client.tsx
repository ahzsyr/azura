...
export type SeoSettingsClientProps = {
  ...
  siteUrl: string;
  sitemapUrl: string;
  structuredDataAudit?: StructuredDataAuditBundle | null;
  structuredPreviewTitle?: string;
  structuredPreviewDescription?: string;
  structuredPreviewUrl?: string;
  structuredFaviconUrl?: string | null;
  structuredSiteName?: string;
  ...
  structuredSitelinkCandidates?: Array<{ title: string; description?: string }>;
};
...
export function SeoSettingsClient({
  ...
  siteUrl,
  sitemapUrl,
  structuredDataAudit = null,
  structuredPreviewTitle,
  structuredPreviewDescription,
  structuredPreviewUrl,
  structuredFaviconUrl,
  structuredSiteName,
  structuredKnowledgePanel,
  structuredSitelinkCandidates,
    ...
    <div className="max-w-6xl space-y-6">
      ...
      >
        {(tab) => {
          ...
          if (tab === "structured") {
            return (
              <StructuredDataSettingsClient
                ...
                embedded
                initialAudit={structuredDataAudit}
                sitemapUrl={sitemapUrl}
                previewTitle={structuredPreviewTitle}
                previewDescription={structuredPreviewDescription}
                previewUrl={structuredPreviewUrl}
                faviconUrl={structuredFaviconUrl}
                siteName={structuredSiteName}
                knowledgePanel={structuredKnowledgePanel}
                sitelinkCandidates={structuredSitelinkCandidates}
              />
            );
          }
          ...
          if (tab === "redirects") {
            return (
              <RedirectsSettingsPanel redirects={redirects} routeCatalog={routeCatalog} embedded />
            );
          }
