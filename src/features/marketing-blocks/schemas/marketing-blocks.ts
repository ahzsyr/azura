...
export const gridItemSchema = z.object({
  ...
  linkLabelEn: z.string().default(""),
  linkLabelAr: z.string().default(""),
  metricEn: z.string().default(""),
  metricAr: z.string().default(""),
});
...
export const beforeAfterPropsSchema = z.object({
  ...
  beforeLabelEn: z.string().default("Before"),
  beforeLabelAr: z.string().default("قبل"),
  afterLabelEn: z.string().default("After"),
  afterLabelAr: z.string().default("بعد"),
