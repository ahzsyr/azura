...
export type PresetEffectsPayload = {
  ...
  cursorEffectSettings?: BackgroundEffectSettings | null;
  textEffectSettings?: BackgroundEffectSettings | null;
  motionSettings?: { intensity: number; opacity: number } | null;
};
...
export type ThemeEngineSnapshot = {
  ...
  /** Appearance change already applied inline — skip color restore / deferred appearance work. */
  appearanceOnly?: boolean;
  /** Device capability/policy tier changed — remount canvases only; never restore appearance. */
