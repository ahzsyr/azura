...
import { SiteBackgroundLayer } from "@/components/theme/site-background-layer";
...
function PreviewChrome({
  ...
  const ctaLabel = tokens.headerConfig.ctaLabel || "Inquire";
      ...
      <div className="space-y-3 p-4">
        ...
        >
          ...
          <p className="mt-1 text-xs opacity-90">
            {tokens.footerConfig.tagline || "Your trusted partner"}
          </p>
        </div>
...
export function ThemePreviewPanel({
  ...
  const savedResolved = useResolvedThemePreview(savedTokens);
