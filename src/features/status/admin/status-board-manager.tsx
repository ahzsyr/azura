...
import type { StatusBoardAdmin } from "@/features/status/types";
import { deleteStatusBoard, toggleStatusBoardPublished } from "@/features/status/actions";
              ...
              <div className="space-y-3 p-4">
                <div>
                  <div className="flex flex-wrap items-center gap-2">
                    <h3 className="font-medium">{board.titleEn}</h3>
                    {!board.isPublished && (
                ...
                <div className="flex flex-wrap gap-1">
                  ...
                  <Button
                    ...
                    disabled={pending}
                    onClick={() => {
                      if (!confirm(`Delete "${board.titleEn}"?`)) return;
                      startTransition(async () => {
