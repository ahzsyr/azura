...
import { toggleDocPortalPublished } from "@/features/documentation/actions";
  ...
  return (
    ...
    >
      ...
      <Card className="max-w-4xl">
        ...
        <CardContent>
          <DocPortalForm portal={portal} mode="edit" embedded formRef={formRef} />
        </CardContent>
      </Card>
