  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>Bottom bar text and legal links.</CardDescription>
      </CardHeader>
      <CardContent className="space-y-4">
        ...
        />
        <FooterLinksEditor
          columnId="copyright-legal"
          links={copyright.legalLinks ?? []}
          onChange={(legalLinks) => setFooterCopyright({ legalLinks })}
        />
      </CardContent>
    </Card>
  );
