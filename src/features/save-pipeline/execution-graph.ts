...
> = {
  ...
  content_changed: {
    ...
    POST: ["blocks", "localeFields", "title", "excerpt", "content"],
  ...
  locale_changed: {
    ...
    POST: ["localeFields", "title", "excerpt", "content"],
    CONTENT_ITEM: ["attributes", "slug", "blocks"],
  },
  searchable_changed: {
    CMS_PAGE: ["slug", "blocks", "localeFields", "title", "excerpt", "content"],
    POST: ["slug", "blocks", "localeFields", "title", "excerpt", "content", "categoryIds", "tagIds"],
  ...
  metadata_changed: {
    ...
    POST: ["scheduledAt", "authorId", "featuredImageId"],
