          ...
          {fields.map((fieldDef) => {
            ...
            return (
              <UniversalTranslationEditor
                ...
                defaultLocaleCode={defaultCode}
                translationValue={translations[fieldDef.field]?.[activeLocale]?.value}
                translationStatus={translations[fieldDef.field]?.[activeLocale]?.status}
                translationId={translations[fieldDef.field]?.[activeLocale]?.id}
                onTranslationSaved={(value, savedStatus) =>
                  setFieldValue(fieldDef.field, activeLocale, value, savedStatus)
                }
              />
            );
          })}
