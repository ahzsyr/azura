...
import type { KnowledgeBaseAdmin } from "@/features/knowledge-base/types";
import { deleteKnowledgeBase, toggleKnowledgeBasePublished } from "@/features/knowledge-base/actions";
              ...
              <div className="space-y-3 p-4">
                <div>
                  <div className="flex flex-wrap items-center gap-2">
                    <h3 className="font-medium">{base.titleEn}</h3>
                    {!base.isPublished && (
                ...
                <div className="flex flex-wrap gap-1">
                  ...
                  <Button
                    ...
                    disabled={pending}
                    onClick={() => {
                      if (!confirm(`Delete "${base.titleEn}"?`)) return;
                      startTransition(async () => {
