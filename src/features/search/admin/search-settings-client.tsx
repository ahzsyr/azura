...
} from "@/features/search/actions/search-settings.actions";
import {
  SEARCH_MODE_OPTIONS,
...
import {
  ...
  TextField,
  SelectField,
} from "@/features/search/admin/search-settings-fields";
import { SearchRankingPanel } from "@/features/search/admin/search-ranking-panel";
import { SearchFiltersPanel } from "@/features/search/admin/search-filters-panel";
import { SearchAnalyticsPanel } from "@/features/search/admin/search-analytics-panel";
              ...
              {customContentTypes.length === 0 ? (
                ...
                customContentTypes.map((t) => {
                  ...
                  return (
                    ...
                    >
                      <div>
                        <span className="font-medium">{t.labelEn}</span>
      ...
      return (
        <div className="space-y-8">
          ...
          <SettingsSection title="Query matching" description="Global search retrieval behavior.">
            ...
            />
            <ToggleField
              label="Arabic LIKE fallback"
              description="Use substring search when query contains Arabic script (no FULLTEXT)."
              checked={s.ranking.arabicLikeFallback}
              onChange={(v) => patchNested("ranking", "arabicLikeFallback", v)}
            />
          </SettingsSection>
        </div>
      );
                      ...
                      customFields: {
                        ...
                        [id]: existing
                          ...
                          : {
                              ...
                              labelEn: discovered!.labelEn,
                              labelAr: discovered!.labelAr,
    ...
    case "appearance":
      return (
        <div className="space-y-6">
          ...
          <SettingsSection title="Appearance" description="Header search UI and placeholder copy.">
          <ToggleField
