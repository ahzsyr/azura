...
import { DEFAULT_SEARCH_SYNONYMS } from "@/features/search/settings/search-smart-defaults";
import type { SearchSmartSettings } from "@/features/search/settings/search-smart.schema";
