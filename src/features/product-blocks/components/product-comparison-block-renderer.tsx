...
import { parseProductComparisonProps } from "@/features/product-blocks/lib/parse-block-props";
      ...
      <div className={title ? "mt-8" : undefined}>
        {block && overflow ? (
          ...
          <ComparisonTable
            ...
            locale={locale}
            specificationsLabel={locale.startsWith("ar") ? "المواصفات" : "Specifications"}
          />
        )}
      </div>
