...
import { mergeShowcasePresetProps } from "@/features/builder/blocks/commerce/commerce-showcase/lib/showcase-block-presets";
...
export function BlockEditor({
  ...
  const handleLegacyPropUpdate = (
    ...
    // Dual-write base key for English so live render can read props.heroTitle etc.
    // without depending solely on EntityTranslation merge.
