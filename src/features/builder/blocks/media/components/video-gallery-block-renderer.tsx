...
import { parseVideoGalleryProps } from "@/features/builder/blocks/media/lib/parse-block-props";
import { VideoGalleryView, type VideoGalleryResolvedItem } from "@/features/builder/blocks/media/components/video-gallery-view";
