...
import { shouldUseResponsiveOverflow } from "@/features/builder/components/marketing-items-overflow";
...
export function MasonryGalleryView({
  ...
  const useOverflow = Boolean(block && overflow && shouldUseResponsiveOverflow(overflow.flags));
