...
export const categoryExplorerSourceSchema = z
  .enum([
    "categories",
    "collections",
    "productCategories",
...
export const categoryExplorerScopeSchema = z
  .enum(["PRODUCT", "CONTENT", "POST", "KNOWLEDGE", "PARTNER", "TESTIMONIAL"])
  .default("PRODUCT");
...
export const categoryExplorerPropsSchema = z.object({
  ...localizedTitleFields,
  source: categoryExplorerSourceSchema.default("categories"),
  scope: categoryExplorerScopeSchema,
