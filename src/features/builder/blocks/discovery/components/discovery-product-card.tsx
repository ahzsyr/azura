...
import { resolveCardPersonalizationFlags } from "@/capabilities/personalization/signals/card-flags";
...
export function DiscoveryProductCardList({
  ...
  const personalizationFlags = resolveCardPersonalizationFlags(personalizationHighlight);
  return (
    <>
