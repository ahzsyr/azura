...
import {
  portalActiveIncidentsLabel,
  portalScheduledMaintenanceLabel,
} from "@/features/builder/blocks/portal/lib/portal-ui-labels";
import type { StatusBoardPublic } from "@/modules/status-page/types";
    ...
    <div className={cn("pb-status", `pb-status--${layout}`)}>
      ...
      {showIncidents && openIncidents.length > 0 && (
        <section className="pb-status__incidents mt-8">
          <h3 className="text-sm font-semibold uppercase tracking-wide text-muted-foreground mb-3">
            {portalActiveIncidentsLabel(locale)}
          </h3>
      ...
      {showMaintenance && board.maintenance.length > 0 && (
        <section className="pb-status__maintenance mt-8">
          <h3 className="text-sm font-semibold uppercase tracking-wide text-muted-foreground mb-3">
            {portalScheduledMaintenanceLabel(locale)}
          </h3>
          <ul className="space-y-3">
