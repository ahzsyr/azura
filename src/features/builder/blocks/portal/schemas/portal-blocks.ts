...
export const knowledgeBasePropsSchema = z.object({
  ...localizedPortalTitleFields,
  presetId: z.literal("knowledge").optional().default("knowledge"),
  templateId: z.enum(["knowledge-article-card"]).optional(),
...
export const teamDirectoryPropsSchema = z.object({
  ...localizedPortalTitleFields,
  presetId: z.literal("team-member").optional().default("team-member"),
  templateId: z.enum(["member-card"]).optional(),
...
export const partnerDirectoryPropsSchema = z.object({
  ...localizedPortalTitleFields,
  presetId: z.literal("partner").optional().default("partner"),
  templateId: z.enum(["partner-card"]).optional(),
