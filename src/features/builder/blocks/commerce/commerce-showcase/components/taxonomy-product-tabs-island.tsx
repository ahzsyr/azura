...
import { TaxonomyTabsShell } from "@/features/builder/blocks/commerce/commerce-showcase/components/taxonomy-tabs-shell";
  ...
  return (
    <div className="w-full">
      ...
      <div className={title || subtitle ? "mt-6 space-y-6" : "space-y-6"}>
        <div
          className={cn(
            p.navStyle === "vertical" && "flex flex-col lg:flex-row gap-6",
          )}
        >
          <TaxonomyTabsShell
            tabs={navTabs}
