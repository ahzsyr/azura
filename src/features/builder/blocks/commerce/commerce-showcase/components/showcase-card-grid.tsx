              ...
              {showImages && (item.iconUrl || item.imageUrl) ? (
                <div className="relative h-12 w-12 shrink-0 overflow-hidden rounded-lg bg-muted">
                  <ShowcaseLogoImage
                    ...
                    fill
                    sizes="48px"
                    className={cn("p-1", grayscale && "grayscale opacity-80")}
                  />
                </div>
              ) : null}
            ...
            <div className="relative h-14 w-14 overflow-hidden rounded-full border bg-card">
              {item.iconUrl || item.imageUrl ? (
                <ShowcaseLogoImage
                  ...
                  fill
                  sizes="56px"
                  className={cn("p-2", grayscale && "grayscale")}
                />
              ) : (
      ...
      {items.map((item) => (
        ...
        >
          {showImages && item.imageUrl ? (
            ...
            >
              <OptimizedImage
                src={normalizeLocalMediaUrl(
                  normalizeRemoteImageUrl(item.imageUrl) ?? item.imageUrl,
                )}
                alt=""
                fill
                skipFade
