...
} from "@/features/builder/blocks/commerce/commerce-showcase/admin/manual-brand-entry-fields";
import {
  buildBrandSelectionPatch,
  orderedBrandSlugsFromProps,
  resolveBrandSelectionFromProps,
} from "@/features/builder/blocks/commerce/commerce-showcase/lib/brand-selection";
import { newShowcaseId, type BrandOverride } from "@/features/builder/blocks/commerce/commerce-showcase/schemas/showcase-blocks";
    ...
    <SettingsSection title="Selection">
      ...
      {selection === "manual" ? (
        <ModalRepeatableListEditor
          ...
          strings={{
            sectionLabel: "Manual brands",
            addButtonLabel: "Add brand",
            emptyLabel: "No manual brands yet. Click Add brand to create one.",
            dialogTitleCreate: "Add brand",
            dialogTitleEdit: "Edit brand",
            saveButtonLabelCreate: "Save brand",
            saveButtonLabelEdit: "Save brand",
          }}
          renderSummary={(brand, index) => ({
            title: brand.name || brand.slug || `Brand ${index + 1}`,
            meta: brand.featured ? ["Featured"] : [],
          })}
