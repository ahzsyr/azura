          ...
          {tabSource === "manual" ? (
            <ModalRepeatableListEditor
              ...
              renderSummary={(tab, index) => ({
                ...
                meta: taxonomy === "brand" && tab.iconUrl ? [`Icon: ${tab.iconUrl}`] : [],
              })}
              renderForm={(draft, onUpdate) => (
                <div className="space-y-3">
                  ...
                  <LocalizedItemFields
                    ...
                    values={{ labelEn: draft.labelEn, labelAr: draft.labelAr }}
                    onChange={(patch) =>
                      onUpdate({
                        labelEn: patch.labelEn ?? draft.labelEn,
                        labelAr: patch.labelAr ?? draft.labelAr,
                      })
                    }
                  />
                  {taxonomy === "brand" ? (
