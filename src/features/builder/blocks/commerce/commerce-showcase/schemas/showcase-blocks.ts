import { z } from "zod";
import { productSortSchema } from "@/features/builder/blocks/commerce/product-blocks/schemas/product-blocks";
...
export const categoryShowcaseSourceSchema = z
  .enum(["categories", "collections", "productCategories", "manual"])
  .transform((v) => (v === "collections" || v === "productCategories" ? "categories" : v));
...
export const categoryShowcasePropsSchema = z.object({
  ...localizedShowcaseFields,
  source: categoryShowcaseSourceSchema.default("categories"),
  scope: z.enum(["PRODUCT", "CONTENT", "POST"]).default("PRODUCT"),
...
export const megaCollectionShowcasePropsSchema = z.object({
  ...
  rightPromoTitle: z.string().default(""),
  rightPromoCta: z.string().default(""),
...
export const PRODUCT_SHOWCASE_TAB_PRESETS: Array<{
  ...
  { id: "best-sellers", label: "Best Sellers", source: "best_sellers" },
  { id: "new-arrivals", label: "New Arrivals", source: "new_arrivals", sortBy: "newest" },
  { id: "trending", label: "Trending", source: "trending" },
  { id: "featured", label: "Featured", source: "featured" },
  { id: "sale", label: "Sale", source: "sale" },
  { id: "recommended", label: "Recommended", source: "recommended" },
];
