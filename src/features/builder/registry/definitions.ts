...
> = {
  ...
  faqSetGrid: {
    ...
    category: "data",
    name: "FAQ Set Grid",
    description: "Grid of all FAQ category cards",
    icon: "layout-grid",
  },
  customHtml: {
    type: "customHtml",
  ...
  contactMap: {
    ...
    name: "Contact Map",
    description:
      "Embed a map (Google, OpenStreetMap, or custom iframe) with optional directions and business-hours overlay.",
    icon: "map",
  },
  contactLocation: {
    ...
    description:
      "Address card with multi-provider map links, business hours, and shared contact card styling.",
    icon: "map-pin",
  },
  contactPhone: {
    type: "contactPhone",
    ...
    description:
      "Data-driven list of phone, email, WhatsApp, support, or any custom contact method with copy and link actions.",
    icon: "phone",
  },
  contactSocial: {
    type: "contactSocial",
    ...
    name: "Contact Social",
    description:
      "Social media icon row or grid with customizable shape, size, hover effects, and response note.",
    icon: "share-2",
  },
  contactSection: {
    type: "contactSection",
    ...
    description:
      "Composition layout that arranges nested contact blocks into left/right columns with a shared theme.",
    icon: "columns",
  },
};
