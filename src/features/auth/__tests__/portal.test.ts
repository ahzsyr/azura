...
describe("sanitizeInternalPath", () => {
  ...
  it("preserves customer account paths", () => {
    ...
    assert.equal(
      sanitizeInternalPath("/en/account/inquiries"),
...
describe("resolvePostLoginRedirect", () => {
  ...
  it("CUSTOMER + /admin/products → /{locale}/account", () => {
    assert.equal(
      resolvePostLoginRedirect({
        role: "CUSTOMER",
        locale: "en",
  ...
  it("CUSTOMER + /en/account/inquiries → same path", () => {
    assert.equal(
      resolvePostLoginRedirect({
        role: "CUSTOMER",
        locale: "en",
...
describe("resolveLoginEntryPath", () => {
  ...
  it("omits unsafe or login-surface callbacks", () => {
    ...
    assert.equal(resolveLoginEntryPath({ locale: "en" }), "/en/account/login");
  });
});
