...
const MYSQL_SOURCES: DataSourceDefinition[] = [
  {
    ...
    list: {
      title: (row) => {
        const r = row as { question?: unknown; faqSet?: { slug?: unknown } };
        return String(r.question ?? r.faqSet?.slug ?? row.id);
      },
      subtitle: (row) => {
...
const JSON_SOURCES: DataSourceDefinition[] = [
  ...
  {
    id: "json:catalog-sync-audit",
    storage: "json-store",
    namespace: "catalog-sync-audit",
    category: "catalog",
    displayName: "Catalog sync audit",
    description: "Recent Catalog Sync Center apply runs (timestamp, counts, warnings)",
    jsonCategory: "settings",
    capabilities: { count: true, browse: true, inspect: true, edit: true, export: true },
  },
  {
    id: "json:catalog-navigation",
    storage: "json-store",
    namespace: "catalog-navigation",
    category: "catalog",
    displayName: "Catalog navigation",
    description: "Catalog Top Navigation scopes (independent from Header Workspace)",
    jsonCategory: "settings",
    capabilities: { count: true, browse: true, inspect: true, edit: true, export: true },
  },
  {
  ...
  {
    id: "json:seo-audit-snapshots",
    storage: "json-store",
    namespace: "seo-audit-snapshots",
    category: "seo",
    displayName: "SEO audit snapshots",
    description: "Workspace site-audit snapshots and normalized issues",
    jsonCategory: "seo",
    capabilities: { count: true, browse: true, inspect: true, edit: true, export: true },
  },
  {
    id: "json:seo-task-state",
    storage: "json-store",
    namespace: "seo-task-state",
    category: "seo",
    displayName: "SEO task state",
    description: "Operator task complete, ignore, and defer state",
    jsonCategory: "seo",
    capabilities: { count: true, browse: true, inspect: true, edit: true, export: true },
  },
  {
    ...
    namespace: "seo-setup",
    category: "seo",
    displayName: "SEO setup",
    description: "One-time SEO setup wizard progress",
    jsonCategory: "seo",
    capabilities: { count: true, browse: true, inspect: true, edit: true, export: true },
  },
  {
  ...
  {
    id: "json:translation-ai",
    storage: "json-store",
    namespace: "translation-ai",
    category: "system",
    displayName: "Translation AI",
    description: "OpenAI API key for Admin → Translations AI queue (secret sealed)",
    jsonCategory: "settings",
    adminHref: "/admin/translations",
    deploymentNavItemId: "translations",
    capabilities: { count: true, browse: true, inspect: true, edit: true, export: true },
  },
  {
