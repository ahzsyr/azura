...
import { readLegacyField } from "@/features/translation/legacy-adapter";
import dynamic from "next/dynamic";

const AdvancedRichTextEditor = dynamic(
  () =>
    import("@/features/content-blocks/admin/advanced-rich-text-editor").then((m) => m.AdvancedRichTextEditor),
...
export function AdvancedRichTextBlockFields({ block, onChange }: Props) {
  ...
  const englishContent =
    readLegacyField(block.props, "content", defaultCode) ||
    (block.props.contentEn as string) ||
    "";
