...
import { OrderedBrandSlugList } from "@/features/commerce-showcase/admin/brand-selection-fields";
import { newShowcaseId } from "@/features/commerce-showcase/schemas/showcase-blocks";
...
export function TaxonomyProductTabsBlockFields({
  ...
  return (
    <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          updateTabs(
                            tabs.map((t) =>
                              t.id === tab.id ? { ...t, labelEn: e.target.value } : t,
                            ),
                          )
                        }
                      />
                    ...
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          updateTabs(
                            tabs.map((t) =>
                              t.id === tab.id ? { ...t, labelAr: e.target.value } : t,
                            ),
                          )
                        }
                      />
      ...
      <AdminCollapsibleSection title="Products" description={(block.props.productLayout as string) ?? "grid"}>
        <SettingsSection title="Product panel">
          <div className="grid grid-cols-2 gap-3">
            <SelectField
              label="Product layout"
              value={(block.props.productLayout as string) ?? "grid"}
              options={[
