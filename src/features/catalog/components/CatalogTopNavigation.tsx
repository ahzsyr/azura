...
function listingBasePathForSurface(
  ...
  switch (surface) {
    case "brandDetail":
      return brandSlug
        ? publicLocalePath(locale, `/brands/${brandSlug}`)
        : publicLocalePath(locale, "/brands");
    case "categoryDetail":
      return categorySlug
        ? publicLocalePath(locale, `/categories/${categorySlug}`)
        : publicLocalePath(locale, "/categories");
    case "brands":
      return publicLocalePath(locale, "/brands");
    case "categories":
      return publicLocalePath(locale, "/categories");
    case "productDetail":
    case "products":
    default:
