        ...
        <div className="pm-edit space-y-6">
          ...
          {editPanel("page-display", active ? (
            <div className="pm-stack">
              ...
              <fieldset className="apm-fieldset">
                <legend className="apm-fieldset__legend">Google Shopping feed</legend>
                <p className="apm-fieldset__hint">
                  Published products are included in{" "}
                  <code>/feeds/google-shopping.xml</code> by default. Check this box to omit
                  this product.
                </p>
                <label className="pm-inline-check">
                  <input
                    type="checkbox"
                    checked={Boolean(active.excludeFromGoogleShopping)}
                    onChange={(e) =>
                      patchActive((prev) => ({
                        ...prev,
