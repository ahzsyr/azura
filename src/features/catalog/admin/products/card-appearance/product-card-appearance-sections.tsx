          ...
          <div className="pca-section__actions">
            ...
            <label className="pca-compare-select">
              ...
              >
                ...
                <option value="media_flip">Media Flip</option>
              </select>
            </label>
          </div>
    ...
    case "actions":
      return (
        <section className="pca-section">
          ...
          {design.style === "media_flip" || design.presetId === "media_flip" ? (
            <Field label="View Details (Media Flip)">
              <OptionButtonGroup
                value={design.viewDetailsMode ?? "product_page"}
                options={[
                  { value: "disabled", label: "Disabled" },
                ...
                onChange={(value) =>
                  studio.patchDesign({
                    viewDetailsMode: value as typeof design.viewDetailsMode,
                  })
                }
              />
              <p className="pca-section__hint">
                Controls the View Details button in the Media Flip card action bar.
              </p>
            </Field>
          ) : null}
        </section>
