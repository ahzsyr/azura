...
import type { PartnerProgramAdmin } from "@/features/partners/types";
import { deletePartnerProgram, togglePartnerProgramPublished } from "@/features/partners/actions";
              ...
              <div className="space-y-3 p-4">
                <div>
                  <div className="flex flex-wrap items-center gap-2">
                    <h3 className="font-medium">{program.titleEn}</h3>
                    {!program.isPublished && (
                ...
                <div className="flex flex-wrap gap-1">
                  ...
                  <Button
                    ...
                    disabled={pending}
                    onClick={() => {
                      if (!confirm(`Delete "${program.titleEn}"?`)) return;
                      startTransition(async () => {
