...
| **Category** | Canonical taxonomy / grouping for entities | `features/categories/` (legacy `collections/` transitional) |
...
> No new top-level concept may be introduced unless it cannot be expressed using: Page, Entity, Template, Block, Category, Lead, Capability, Preset, Module.
