...
| **Category** | Canonical taxonomy / grouping for Entities | Categories (sole user-facing term) |
| **Collection** | *(legacy)* former name for Category | Prefer Category; transitional until Stage 7 |
...
| `ContentCollection` | Category | scope CONTENT; legacy table until migration |
| `Product` | Entity | preset: `product` |
| `CatalogCollection` | Category | scope PRODUCT; legacy table until migration |
| `PostCategory` | Category | scope POST |
| `KnowledgeCategory` | Category | scope KNOWLEDGE |
| `PartnerCategory` | Category | scope PARTNER |
| `TestimonialCollection` | Category | scope TESTIMONIAL |
...
| product-catalog | Collections | `/admin/collections` | content | Categories | `product` |
