...
> **Top-bar actions:** [admin-action-system.md](./admin-action-system.md) — global Save/Publish/Cancel registration, ownership stack, CI inventory
...
│      Audit                          │
│      Basic SEO                      │
│      Advanced SEO                   │  ← specialist tools (always listed; profile/module gated)
│          Search Appearance          │
│          Search Operations          │  ← enterprise
│          Search Intelligence        │
├─────────────────────────────────────┤
│  ▼ Modules                          │
│      Documentation                  │
...
SEO          → Dashboard, Tasks, Audit, Basic SEO, Advanced SEO
               (Advanced SEO includes Search Appearance, Metadata, Schema, integrations, Search Operations when enabled)
...
| `advanced-seo` | *(items under SEO → Advanced SEO)* | Search Operations, Search Intelligence, schema registry, 404 | enterprise |
...
| **SEO Audit / Integrations / 404** | Site Audit is operator-facing; Search Engine Integrations and 404 stay under **Advanced SEO** (enterprise / profile gated) | advanced-seo Module overlay |
...
| seo | SEO | `/admin/seo` | seo | Dashboard | — |
| seo | Site Audit | `/admin/seo/audit` | seo | Site Audit | — |
| seo | Tasks | `/admin/seo/tasks` | seo | All Tasks | — |
...
| seo | SEO Integrations | `/admin/seo/integrations` | seo | Search Engines | advanced-seo |
