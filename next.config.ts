...
import { parsePreferredSiteUrl } from "./src/lib/preferred-host";
...
/** Permanent www↔apex consolidation toward NEXT_PUBLIC_SITE_URL. */
function preferredHostRedirects(): {
  ...
  const alternateHost = preferredIsWww
    ? preferred.hostname.slice(4)
