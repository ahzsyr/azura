...
store pages, MikroTik product pages, raw JSON, JSON-LD Product schema, or
generic product HTML into WooCommerce CSV + JSON.
...
def process_single(
    ...
    *,
    ...
    if resolved_format == "auto":
        if parser_name == "unifi_store":
            resolved_format = "unifi"
        elif parser_name == "mikrotik":
            resolved_format = "mikrotik"
        else:
            resolved_format = "default"
