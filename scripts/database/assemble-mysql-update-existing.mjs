...
-- ========== 5b. FaqSet.coverUrl (TEXT for CDN URLs) ==========
CALL azura_add_column('FaqSet', 'coverUrl', 'TEXT NULL');
-- Widen if an older VARCHAR(191) column already exists
SET @faq_cover_type = (
...
EXECUTE faq_cover_stmt;
DEALLOCATE PREPARE faq_cover_stmt;
