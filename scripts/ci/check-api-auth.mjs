...
for (const file of files) {
  ...
  const publicPrefixes = [
    ...
    "admin/",
    "content/",
    // seo/: folder allowlisted during migration; runtime auth differs per route:
    //   /api/seo/head — public (Yoast REST parity)
    //   /api/seo/analyze — requireAdmin() at runtime
    //   /api/seo/debug — requireAdmin() at runtime
    //   /api/seo/indexnow-key/* — public key file
    "seo/",
    "sync-collections",
    "save-settings",
    "coming-soon",
