...
function validateMeta(record, target) {
  ...
  if (!record.titleAr?.trim()) problems.push(issue("error", "missing-title-ar", "Missing Arabic title", target));
  if (!record.descriptionEn?.trim()) {
    problems.push(issue("error", "missing-description-en", "Missing English description", target));
  }
  if (!record.descriptionAr?.trim()) {
    problems.push(issue("error", "missing-description-ar", "Missing Arabic description", target));
  }
