-- AZURA MySQL full standalone create script
-- Executes schema creation for MySQL 8+
CREATE DATABASE IF NOT EXISTS `azura` CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE `azura`;
-- AZURA â€” MySQL 8+ schema (generated from prisma/schema.prisma)
-- Import via phpMyAdmin: select database â†’ Import â†’ choose this file
...
CREATE TABLE `LocaleConfig` (
    ...
    `flag` VARCHAR(191) NOT NULL DEFAULT 'ًںŒگ',
...
CREATE TABLE `ContentType` (
    ...
    `labelSingularAr` VARCHAR(191) NOT NULL DEFAULT 'ط¹ظ†طµط±',
    `labelPluralEn` VARCHAR(191) NOT NULL DEFAULT 'Items',
    `labelPluralAr` VARCHAR(191) NOT NULL DEFAULT 'ط¹ظ†ط§طµط±',
...
CREATE TABLE `PricingPlan` (
    ...
    `ctaLabelAr` VARCHAR(191) NOT NULL DEFAULT 'ط§ط¨ط¯ط£ ط§ظ„ط¢ظ†',
