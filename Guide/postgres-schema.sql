-- AZURA PostgreSQL full standalone create script
-- Includes base schema plus project migrations


-- ============================================================
-- Source: database/postgres/01-schema.sql
-- ============================================================
-- AZURA â€” PostgreSQL schema for Supabase (generated from prisma/schema.prisma)
...
CREATE TABLE "SiteTheme" (
    ...
    "backgroundEffectSettings" JSONB NOT NULL DEFAULT '{}',
    "cardStyle" TEXT,
    "borderStyle" TEXT,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
CREATE TABLE "LocaleConfig" (
    ...
    "flag" TEXT NOT NULL DEFAULT 'ًںŒگ',
...
CREATE TABLE "ContentType" (
    ...
    "labelSingularAr" TEXT NOT NULL DEFAULT 'ط¹ظ†طµط±',
    "labelPluralEn" TEXT NOT NULL DEFAULT 'Items',
    "labelPluralAr" TEXT NOT NULL DEFAULT 'ط¹ظ†ط§طµط±',
...
CREATE TABLE "PricingPlan" (
    ...
    "ctaLabelAr" TEXT NOT NULL DEFAULT 'ط§ط¨ط¯ط£ ط§ظ„ط¢ظ†',
...
-- CreateIndex
CREATE INDEX "Product_locale_brand_idx" ON "Product"("locale", "brand");

-- CreateIndex
CREATE INDEX "Product_locale_category_idx" ON "Product"("locale", "category");

-- CreateIndex
CREATE INDEX "Product_locale_status_idx" ON "Product"("locale", "status");

-- CreateIndex
CREATE INDEX "Product_locale_stockStatus_idx" ON "Product"("locale", "stockStatus");

-- CreateIndex
CREATE INDEX "Product_locale_priceValue_idx" ON "Product"("locale", "priceValue");
...
-- CreateIndex
CREATE INDEX "CatalogCollection_parentSlug_idx" ON "CatalogCollection"("parentSlug");

-- CreateIndex
CREATE INDEX "CatalogCollection_visible_idx" ON "CatalogCollection"("visible");

-- CreateIndex
CREATE INDEX "CatalogCollectionLocale_locale_idx" ON "CatalogCollectionLocale"("locale");

-- CreateIndex
CREATE UNIQUE INDEX "CatalogCollectionLocale_collectionId_locale_key" ON "CatalogCollectionLocale"("collectionId", "locale");
...
-- ============================================================
-- Source: database/postgres/04-catalog-products-table.sql
-- ============================================================
-- AZURA â€” Catalog Product table for Supabase (PostgreSQL)
--
-- Hybrid storage:
--   â€¢ SQL columns â€” listing filters, sort, search
--   â€¢ payload JSONB â€” full converter/import product document
--
-- Run in Supabase â†’ SQL Editor after 01-schema.sql (or on an existing project).
-- Safe to re-run: uses IF NOT EXISTS for table, columns, and indexes.
--
-- Prisma model: prisma/schema.prisma â†’ model Product
...
-- ============================================================
-- Source: database/postgres/05-catalog-collections.sql
-- ============================================================
-- AZURA â€” Catalog Collection tables for Supabase (PostgreSQL)
--
-- Run in Supabase â†’ SQL Editor after 04-catalog-products-table.sql.
-- Safe to re-run: uses IF NOT EXISTS for table, columns, and indexes.
--
...
-- ============================================================
-- Source: database/postgres/06-site-settings.sql
-- ============================================================
...
-- ============================================================
-- Source: database/postgres/07-search-analytics.sql
-- ============================================================
...
-- ============================================================
-- Source: database/postgres/08-search-fts.sql
-- ============================================================
...
-- ============================================================
-- Source: database/postgres/09-media-asset-scope.sql
-- ============================================================
...
-- ============================================================
-- Source: database/postgres/10-catalog-collection-conditions.sql
-- ============================================================
-- AZURA â€” Align CatalogCollection.rules -> conditions (PostgreSQL / Supabase)
--
-- Run in Supabase â†’ SQL Editor after 05-catalog-collections.sql.
-- Safe to re-run.
...
-- ============================================================
-- Source: database/postgres/11-translation-only-architecture.sql
-- ============================================================
-- AZURA â€” Translation-only architecture (Supabase / PostgreSQL)
--
...
--
-- Run in Supabase â†’ SQL Editor after 01-schema.sql â€¦ 10-catalog-collection-conditions.sql
...
-- ---------------------------------------------------------------------------
-- 3. Rename languageCode â†’ localeCode; add version on EntityTranslation
-- ---------------------------------------------------------------------------
DO $$
BEGIN
  IF EXISTS (
...
-- ---------------------------------------------------------------------------
-- 5. CatalogCollection â€” drop name/description + locale overrides table
-- ---------------------------------------------------------------------------
ALTER TABLE "CatalogCollection"
...
-- ============================================================
-- Source: database/postgres/12- SEO tables migration
-- ============================================================
DO $$
BEGIN
...
-- ============================================================
-- Source: database/postgres/13- theme update
-- ============================================================
